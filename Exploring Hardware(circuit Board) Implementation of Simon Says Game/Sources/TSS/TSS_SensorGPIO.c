...
#include "TSS_SensorGPIO.h"
  ...
  #include "TSS_GPIO.h"
    ...
    /**********************  Modules definition **********************/
      ...
      #if TSS_DETECT_PORT_METHOD(A,GPIO)
        const    TSS_GPIO_METHOD_ROMDATA TSS_GPIO_PORTA_METHOD_ROMDATA_CONTEXT = {GPIO_MethodControl, (uint32_t*) TSS_HW_TIMER_PTR, (uint32_t*) GPIOA_BASE_PTR, TSS_HW_TIMER_VECTOR-16};
      #endif
      #if TSS_DETECT_PORT_METHOD(B,GPIO)
        const    TSS_GPIO_METHOD_ROMDATA TSS_GPIO_PORTB_METHOD_ROMDATA_CONTEXT = {GPIO_MethodControl, (uint32_t*) TSS_HW_TIMER_PTR, (uint32_t*) GPIOB_BASE_PTR, TSS_HW_TIMER_VECTOR-16};
      #endif
      #if TSS_DETECT_PORT_METHOD(C,GPIO)
        const    TSS_GPIO_METHOD_ROMDATA TSS_GPIO_PORTC_METHOD_ROMDATA_CONTEXT = {GPIO_MethodControl, (uint32_t*) TSS_HW_TIMER_PTR, (uint32_t*) GPIOC_BASE_PTR, TSS_HW_TIMER_VECTOR-16};
      #endif
      #if TSS_DETECT_PORT_METHOD(D,GPIO)
        const    TSS_GPIO_METHOD_ROMDATA TSS_GPIO_PORTD_METHOD_ROMDATA_CONTEXT = {GPIO_MethodControl, (uint32_t*) TSS_HW_TIMER_PTR, (uint32_t*) GPIOD_BASE_PTR, TSS_HW_TIMER_VECTOR-16};
      #endif
      #if TSS_DETECT_PORT_METHOD(E,GPIO)
        const    TSS_GPIO_METHOD_ROMDATA TSS_GPIO_PORTE_METHOD_ROMDATA_CONTEXT = {GPIO_MethodControl, (uint32_t*) TSS_HW_TIMER_PTR, (uint32_t*) GPIOE_BASE_PTR, TSS_HW_TIMER_VECTOR-16};
      #endif
      #if TSS_DETECT_PORT_METHOD(F,GPIO)
        const    TSS_GPIO_METHOD_ROMDATA TSS_GPIO_PORTF_METHOD_ROMDATA_CONTEXT = {GPIO_MethodControl, (uint32_t*) TSS_HW_TIMER_PTR, (uint32_t*) GPIOF_BASE_PTR, TSS_HW_TIMER_VECTOR-16};
      #endif
      #if TSS_DETECT_PORT_METHOD(G,GPIO)
        const    TSS_GPIO_METHOD_ROMDATA TSS_GPIO_PORTG_METHOD_ROMDATA_CONTEXT = {GPIO_MethodControl, (uint32_t*) TSS_HW_TIMER_PTR, (uint32_t*) GPIOG_BASE_PTR, TSS_HW_TIMER_VECTOR-16};
      #endif
      #if TSS_DETECT_PORT_METHOD(H,GPIO)
        const    TSS_GPIO_METHOD_ROMDATA TSS_GPIO_PORTH_METHOD_ROMDATA_CONTEXT = {GPIO_MethodControl, (uint32_t*) TSS_HW_TIMER_PTR, (uint32_t*) GPIOH_BASE_PTR, TSS_HW_TIMER_VECTOR-16};
      #endif
      #if TSS_DETECT_PORT_METHOD(I,GPIO)
        const    TSS_GPIO_METHOD_ROMDATA TSS_GPIO_PORTI_METHOD_ROMDATA_CONTEXT = {GPIO_MethodControl, (uint32_t*) TSS_HW_TIMER_PTR, (uint32_t*) GPIOI_BASE_PTR, TSS_HW_TIMER_VECTOR-16};
      #endif
      #if TSS_DETECT_PORT_METHOD(J,GPIO)
        const    TSS_GPIO_METHOD_ROMDATA TSS_GPIO_PORTJ_METHOD_ROMDATA_CONTEXT = {GPIO_MethodControl, (uint32_t*) TSS_HW_TIMER_PTR, (uint32_t*) GPIOJ_BASE_PTR, TSS_HW_TIMER_VECTOR-16};
      #endif
    #else /* (TSS_GPIO_VERSION == 1) */
      #if TSS_DETECT_PORT_METHOD(A,GPIO)
